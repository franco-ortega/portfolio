    ...
    <ContinentPopUp>
      ...
      <section className={styles.Bio}>
        <span>
          ...
          and build out features across the stack. I appreciate well-documented
          and efficient processes that offer structure and flexibility. I value
          clear and kind communication, cross-functional collaboration, and
          supportive environments that foster diversity and nurture growth.
          Optimism guides my efforts while practicality ensures that my goals
        ...
        <span>
          ...
          cartography, and board game design. Other things that bring me joy are
