        ...
        <section className={styles.InnerCoastline}>
          <section className={styles.Continent}>
            ...
            <section className={styles.Bio}>
              ...
              <p className={styles.BioParagraph}>
                Furthermore, in addition to growing up as a math and science kid, I have learned to appreciate and nurture my creative side through writing, cartography, and boardgame design. Other things that make me smile include bouldering, getting around on bike, attending art events, sharing food at potlucks, and visiting friends who have wound up in far-flung places. Also, roller hockey, punk rock, and zines were big parts of my past that I still very much appreciate and occasionally enjoy in smaller doses these days.
              </p>
              <p className={styles.BioParagraph}>
